...
(function($, Coral) {
    ...
    registry.register("foundation.validation.validator", {
        selector: "[data-validation=custom-validation]",
        validate: function(element) {
            ...
            if(items>max){
              ...
              return "You can add maximum "+max+" Button. You are trying to add "+items+"th button."
            }
            if(items<min){
    ...
    registry.register("foundation.validation.validator", {
        selector: "[data-validation=text-custom-validation]",
        validate: function(element) {
            let el = $(element);
            let pattern=/[0-9a-z]/;
            let value=el.val();
